...
> Открыть эту страницу в [https://dahmv.github.io/test/](https://dahmv.github.io/test/)
...
* найдите **https://github.com/dahmv/test** и импортируйте
...
* вставьте **https://github.com/dahmv/test** и нажмите Импорт
